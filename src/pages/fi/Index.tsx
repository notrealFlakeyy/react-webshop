    ...
    <LayoutFi>
      <main>
              ...
              <div className="mx-auto max-w-md px-6 sm:max-w-2xl sm:text-center lg:flex lg:items-center lg:px-0 lg:text-left">
                <div className="lg:py-24">
                  ...
                  <h1 className="mt-4 text-4xl font-bold tracking-tight text-white sm:mt-5 sm:text-6xl lg:mt-6 xl:text-6xl">
                    <span className="block">Turvallista matkaa</span>
                    <span className="block bg-gradient-to-r from-teal-200 to-cyan-400 bg-clip-text pb-3 text-transparent sm:pb-5">
                      koko Suomessa
                    </span>
                  </h1>
                  <p className="text-base text-gray-300 sm:text-xl lg:text-lg xl:text-xl">
                    Olemme Oravaisissa sijaitseva taksi- ja linja-autoalan perheyritys, jonka asiakaslähtöisyys on keskiössä
                  </p>
          ...
          <div className="mx-auto max-w-md px-6 text-center sm:max-w-3xl lg:max-w-7xl lg:px-8">
            <div>
              ...
              <p className="mx-auto mt-5 max-w-prose text-xl text-gray-500">
                Käytämme uusiutuvia polttoaineita ja laajennamme autokantaamme vastaamaan nykyisiä ympäristömääräyksiä. Tässä on yksi sähköautoistamme.
              </p>
            </div>
        ...
        <div className="relative bg-white py-16 sm:py-24 lg:py-32">
          <div className="mx-auto max-w-md px-6 text-center sm:max-w-3xl lg:max-w-7xl lg:px-8">
            <p className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">
              Kaikki mitä haluat taksilta yhdessä paketissa.
            </p>
            <div className="mt-12">
                ...
                <blockquote>
                  <div className='flex items-center'>
                    ...
                    <p className="mt-6 text-2xl font-medium text-white">
                      Invataksi pyörätuolille ja paareille.
                    </p>
                  </div>
                </blockquote>
              </div>
        ...
        <div className="relative bg-gray-900">
          ...
          <div className="relative mx-auto max-w-md px-6 py-12 sm:max-w-7xl sm:py-20 md:py-28 lg:px-8 lg:py-32">
            <div className="md:ml-auto md:w-1/2 md:pl-10">
              <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">Olemme täällä sinua varten!</p>
              <p className="mt-3 text-lg text-gray-300">
                Tarjoamme kaikenlaista matkustajaliikennettä tarpeisiisi mukautetuilla ajoneuvoilla.
              </p>
              <div className="mt-8">
